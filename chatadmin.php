...
<div id="chat">
    <form action="vendor\nnobr.php" method="post">
        <label>Удалить сообщение</label>
        <p>Введите текст сообщения из чата, которое хотите удалить</p>
        <input type="text" name="delete" placeholder="Введите текст сообщения">
        <button type="submit" name="delete5">Удалить</button>
    </form>
</div>
</body>
</html>
