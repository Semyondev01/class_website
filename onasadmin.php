...
<div class="onas" id="onas">
    <form action="vendor\onas.php" enctype="multipart/form-data" method="post">
        <label>Страница "О нас"</label>
        <textarea type="text" name="onas" placeholder="Введите то, что будет на странице О нас"></textarea>
        <input type="file" name="image">
        <button>Отправить</button>
    </form>
    <form action="vendor/onass_delete.php" method="post">
        <button>Удалить всё, что находится на странице О нас</button>
    </form>
</div>
</body>
</html>