...
<div id="pol">
    <form action="vendor/update.php" method="post">
        <p>Заменить статус на:</p>

        <input type="radio" name="update" value="admin">admin</input><br>
        <input type="radio" name="update" value="chat">chat</input><br>
        <input type="radio" name="update" value="2system">2system</input><br>
        <input type="radio" name="update" value="user">user</input><br>
        <a href="vendor/arry.php">Посмотреть массив из базы данных</a>

        <label>Введите id пользователя</label>
        <input type="text" name="system">
        <button name="button111">Заменить</button>
    </form>
</div>
</body>
</html>
